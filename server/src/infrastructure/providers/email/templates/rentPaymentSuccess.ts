...
export const TemplatePaymentDueTomorrow = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Payment Due Tomorrow</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f4f5f7; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #333333; -webkit-font-smoothing: antialiased;">
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f4f5f7; padding: 40px 0;">
    <tr>
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding: 0 40px 30px 40px; font-size: 15px; line-height: 1.6; color: #4b5563;">
              ...
              <p>This is a friendly reminder that your upcoming payment for <strong>{{propertyName}}</strong>, Unit <strong>{{unitNumber}}</strong> is due tomorrow, <strong>{{dueDate}}</strong>.</p>
              ...
              <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 6px; padding: 20px; margin: 24px 0;">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 14px; color: #374151;">
                  ...
                  <tr>
                    <td style="padding: 4px 0; font-weight: 500;">Billing Cycle:</td>
                    <td style="padding: 4px 0;">{{billingCycle}}</td>
                  </tr>
                  <tr>
                    <td style="padding: 4px 0; font-weight: 500;">Payment Due Date:</td>
                    <td style="padding: 4px 0; font-weight: 700; color: #d97706;">{{dueDate}}</td>
                  </tr>
                </table>
              </div>

              <!-- Occupants / Tenant Info -->
              <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 6px; padding: 20px; margin-bottom: 24px;">
                <p style="margin: 0 0 12px 0; font-weight: 600; color: #111827; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em;">
                  Tenant Details
                </p>
              ...
              <p style="color: #374151;">
                ...
                Please log into the tenant portal to make your payment securely.
              </p>
              ...
              <p style="font-size: 13px; color: #6b7280; margin-bottom: 0;">
                If you have already processed this payment via the portal, please ignore this notice or contact support at <strong>{{supportEmail}}</strong>.
              </p>
            </td>
          </tr>
...
export const TemplateRentPaymentOverdue = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Overdue Rent Payment Notice</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f4f5f7; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; color: #333333; -webkit-font-smoothing: antialiased;">
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #f4f5f7; padding: 40px 0;">
    <tr>
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding: 0 40px 30px 40px; font-size: 15px; line-height: 1.6; color: #4b5563;">
              ...
              <p>Our records show that we have not yet received your rent payment for <strong>{{propertyName}}</strong>, Unit <strong>{{unitNumber}}</strong>, which was due yesterday (<strong>{{dueDate}}</strong>).</p>
              ...
              <div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 6px; padding: 20px; margin: 24px 0;">
                <p style="margin: 0 0 12px 0; font-weight: 600; color: #991b1b; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em;">
                  Lease & Account Summary
                </p>
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size: 14px; color: #7f1d1d;">
                  <tr>
                    <td style="padding: 4px 0; font-weight: 500; width: 160px;">Property Name:</td>
                    <td style="padding: 4px 0; font-weight: 600; color: #111827;">{{propertyName}}</td>
                  </tr>
                  <tr>
                    <td style="padding: 4px 0; font-weight: 500;">Unit Number:</td>
                    <td style="padding: 4px 0; font-weight: 600; color: #111827;">{{unitNumber}}</td>
                  </tr>
                  <tr>
                    <td style="padding: 4px 0; font-weight: 500;">Lease Type:</td>
                    <td style="padding: 4px 0;">{{leaseType}}</td>
                  ...
                  <tr>
                    <td style="padding: 4px 0; font-weight: 500;">Original Due Date:</td>
                    <td style="padding: 4px 0; font-weight: 700; color: #dc2626;">{{dueDate}}</td>
                  </tr>
                </table>
              </div>

              <!-- Occupants / Tenant Information -->
              <div style="background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 6px; padding: 20px; margin-bottom: 24px;">
                <p style="margin: 0 0 12px 0; font-weight: 600; color: #111827; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em;">
                  Tenant Details
                </p>
              ...
              <p style="color: #374151;">
                ...
                Please log in to your tenant portal as soon as possible to make your payment and avoid any potential late fees.
              </p>
              ...
              <p style="font-size: 13px; color: #6b7280; margin-bottom: 0;">
                If you have already submitted your payment within the last 24 hours, please disregard this notice or contact support at <strong>{{supportEmail}}</strong>.
              </p>
            </td>
          </tr>
