...
export default function LoginPage() {
  ...
  if (!isSubdomain) {
    return (
      <div className="flex min-h-svh items-center justify-center bg-[#121212] p-6">
        <Card className="w-full max-w-md border-muted bg-card/50 backdrop-blur-sm">
          ...
          <CardContent className="flex flex-col gap-4 pt-4">
            <div className="rounded-lg bg-muted/40 p-4 text-xs text-muted-foreground border border-border/40">
              <p className="font-semibold text-foreground mb-1">Expected URL Format:</p>
              <code>https://company-name.{rootDomain || "yourdomain.com"}/login</code>
            </div>
